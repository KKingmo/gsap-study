...
useEffect(() => {
  const ctx = gsap.context(() => {
    ...
    gsap.from('.bird', { delay: 1, duration: 1, opacity: 0, y: 100 });
    gsap.from('.gress', { delay: 3, duration: 1, opacity: 0, y: 100 });
...
const MattersOfTimelines = () => {
	...
	return (
		<PageLayout>
			<Typography variant='h1'>타임라인이 중요한 이유</Typography>
			<Box ref={tweenRef}>
				<svg
			...
			<Typography variant='body2'>
				{
					'타임라인을 사용하지 않으면 순차적으로 진행되는 애니메이션을 구현할 때 일일이 delay타임을 계산해서 설정해줘야합니다\n이는 매우 번거로운 작업이고 비효율적입니다.\n\n아래 코드는 타임라인을 사용하지 않고 트윈으로만 순차적으로 진행되는 애니메이션을 구현한 의사코드입니다.\n\n타임라인을 사용하면 훨씬 간편하고 효율적으로 스토리 있는 애니메이션을 구현할 수 있습니다.'
				}
			</Typography>
...
export default MattersOfTimelines;
